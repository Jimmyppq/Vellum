...
Este documento contiene las reglas inviolables y la metodología de trabajo que cualquier Agente de Inteligencia Artificial (especialmente Antigravity) debe seguir al momento de analizar, planificar o codificar dentro de este repositorio (`Vellum`).
...
- **Las Especificaciones como fuente de verdad:** Antes de realizar modificaciones de alto impacto o insertar nuevas funcionalidades (Features), el Agente siempre debe solicitar o proponer la redacción de un documento `specs/spec.md`.
...
- **ChangeLog** Debe incluir un registro de cambios detallado de todo lo realizado, por versión. archivo CHANGELOG.MD en la raiz del proyecto.
- **Versionado** archivo Version.py debe estar siempre actualizado con la version actual del proyecto. El versionado sigue el formato `X.Y.Z`, donde:
- **X** es la versión mayor.
- **Y** es la versión menor.
- **Z** es la versión de patch.
